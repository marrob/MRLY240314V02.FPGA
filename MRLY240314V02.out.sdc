## Generated SDC file "MRLY240314V02.out.sdc"
...
create_clock -name {slu_strobe} -period 1.000 -waveform { 0.000 0.500 } [get_ports {slu_strobe}]
...
set_clock_uncertainty -fall_from [get_clocks {slu_strobe}] -rise_to [get_clocks {clk}]  0.040  
set_clock_uncertainty -fall_from [get_clocks {slu_strobe}] -fall_to [get_clocks {clk}]  0.040  
